...
另外对于pull_out也有同样的问题
解决方案也要修改源代码
但是有一个问题,就是你的源代码的获取途径,
直接从github上克隆的代码貌似和gradle下载的不一样
gradle下载的源代码可以到:C:\Users\Administrator\.gradle\caches\modules-2\files-2.1\com.daimajia.swipelayout\library\1.2.0去寻找
![](http://i.imgur.com/wARj2fV.jpg)
![](http://i.imgur.com/EziA7RA.jpg)

修改后的代码,可以搜索 "我的修改" 查看我修改了哪里,有4处
```java
